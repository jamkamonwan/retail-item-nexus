...
export const mockUsers: MockUser[] = [
  ...
  {
    id: 'user-supplier-admin-001',
    email: 'unilever.admin@unilever.com',
    fullName: 'Somchai Unilever',
    role: 'supplier_admin',
    userType: 'external',
    status: 'active',
    supplierId: 'supplier-009',
    supplierName: 'Unilever - Hardline',
    supplierGroupId: 'group-001',
    permissions: [],
  ...
  {
    id: 'user-supplier-admin-002',
    email: 'nestle.admin@nestle.com',
    fullName: 'Pranee Nestle',
    role: 'supplier_admin',
    userType: 'external',
    status: 'active',
    supplierId: 'supplier-001',
    supplierName: 'ACME Corporation',
    supplierGroupId: 'group-003',
    permissions: [],
    createdAt: new Date('2024-05-10'),
    lastLoginAt: new Date('2025-01-28'),
  },
  {
    id: 'user-supplier-003',
    email: 'wichai@nestle.com',
    fullName: 'Wichai Supplier',
    role: 'supplier',
    userType: 'external',
    status: 'active',
    supplierId: 'supplier-002',
  ...
  {
    id: 'user-supplier-004',
    email: 'apinya@cpgroup.com',
    fullName: 'Apinya CP Foods',
    role: 'supplier',
    userType: 'external',
    status: 'active',
    supplierId: 'supplier-003',
    supplierName: 'Fresh Produce Co',
    supplierGroupId: 'group-004',
    permissions: [],
    createdAt: new Date('2024-07-15'),
    lastLoginAt: new Date('2025-01-20'),
  },
  {
    id: 'user-supplier-005',
    email: 'inactive.supplier@old.com',
    fullName: 'Inactive Supplier',
    role: 'supplier',
    userType: 'external',
    status: 'inactive',
